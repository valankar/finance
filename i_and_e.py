...
def get_toshl_expenses_dataframe():
    ...
    for category, tag, new_category in (
        ...
        ("Transport", ["car", "fuel", "toll", "parking"], "Travel:Car"),
        ("Transport", "airplane", "Travel:Air"),
        ...
        ("Charity", None, "Gifts"),
        ("Leisure", "airplane", "Travel:Air"),
        ("Leisure", "travel", "Travel:Air"),
        ("Leisure", "accommodation", "Travel:Accomodation"),
